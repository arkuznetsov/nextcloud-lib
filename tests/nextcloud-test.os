...
Процедура ТестДолжен_ПолучитьСписокФайловВКаталоге() Экспорт
	...
	Утверждения.ПроверитьРавенство(Сервис.Файлы().Список(ИмяТестовогоКаталога).Количество(), 1, ТекстОшибки);
...
Процедура ТестДолжен_ПолучитьФайл() Экспорт
	...
	Утверждения.ПроверитьРавенство(Текст.ПолучитьТекст(), ТекстДляПроверки, ТекстОшибки);
